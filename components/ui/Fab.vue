<template>
    <div :class="`fixed ${right ? `bottom-0 right-0` : `top-0 left-0`} z-40`">
        <div
            class="relative flex flex-col items-center gap-10 justify-start font-atmospheric"
        >
            <button
                :class="`
                  inline-flex
                  items-center z-50
                  justify-center w-16 h-16 bg-white lg:bg
      ...
      `"
            ...
            >
                ...
                <svg
                    :class="`block h-8 w-8 text-black stroke-2 stroke-black lg:stroke-black`"
            ...
            >
                ...
                >
                    <MiscTag type="a" class="w-full"
                        ><div class="font-bold w-full" style="font-size: 13px; letter-spacing: 2px;">
                            {{ route.name }}
                        </div></MiscTag
                    >
                </div> </a
